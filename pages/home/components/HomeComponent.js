        ...
        >
          <Card
            ...
            title={
              <b>
                {productList[i].label ? (
                  <Tag color="green">{productList[i].label.name}</Tag>
                ) : null}
              </b>
            }
            cover={
              ...
              <div>
                <div className={styles.price_wrapper}>
                  <Row>
                    ...
                    <div className={styles.price}>{productList[i].price}</div>
                  </Row>
                </div>
    ...
    categoryCards.push(
      ...
      >
        <Card
          ...
          cover={
            <center>
              <img alt="icon" src={categoryList[i].image} />
            </center>
          }
        ></Card>
      </Col>
    ...
    <div>
      ...
      <Card style={{ marginTop: "50px" }}>
        <div>
          ...
          <Row style={{ paddingLeft: "10px" }}>{categoryCards}</Row>
        </div>
      </Card>
      <Card style={{ marginTop: "50px" }}>
        <div>
          ...
          <Row style={{ paddingLeft: "10px" }}>{productCards}</Row>
        </div>
      </Card>
    </div>
  );
